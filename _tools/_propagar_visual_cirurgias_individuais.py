...
ARQUIVOS = [
    'cirurgias/Carolina_Mardegan.html',
    'cirurgias/Clara_Silva_Freitas.html',
    'cirurgias/Daniela_Viese_Roth.html',
    'cirurgias/Igor_Rafael_Sincos.html',
    'cirurgias/Manoel_Augusto_Lobato.html',
]
